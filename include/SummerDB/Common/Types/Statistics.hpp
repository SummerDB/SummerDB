#ifndef SUMMERDB_COMMON_TYPES_STATISTICS_HPP
#define SUMMERDB_COMMON_TYPES_STATISTICS_HPP
...
class Statistics {
 public:
  ...
  // A - B
  static void Subtract(Statistics& left, Statistics& right, Statistics& result);
  // A * B
  static void Multiply(Statistics& left, Statistics& right, Statistics& result);
  // A / B
...
#endif  // SUMMERDB_COMMON_TYPES_STATISTICS_HPP