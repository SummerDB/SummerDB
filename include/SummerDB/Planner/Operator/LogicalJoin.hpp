#ifndef SUMMERDB_PLANNER_OPERATOR_LOGICAL_JOIN_HPP
#define SUMMERDB_PLANNER_OPERATOR_LOGICAL_JOIN_HPP
    ...
    if (conditions.size() > 0) {
      ...
      for (size_t i = 0; i < conditions.size(); i++) {
        ...
        result += ExpressionTypeToString(cond.comparison) + "(" +
                  cond.left->ToString() + ", " + cond.right->ToString() + ")";
...
#endif  // SUMMERDB_PLANNER_OPERATOR_LOGICAL_JOIN_HPP